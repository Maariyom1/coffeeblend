        ...
        <div class="container">
            <div class="row slider-text justify-content-center align-items-center">
                <div class="col-md-7 col-sm-12 text-center ftco-animate">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">{{{ __('messages.Home') }}}</a></span> <span>{{ __('messages.Register') }}</span></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 ftco-animate">
                <form method="POST" action="{{ route('register') }}" class="billing-form ftco-bg-dark p-3 p-md-5">
                    @csrf
                    <h3 class="text-white mb-4 billing-heading">{{ __('messages.Register') }}</h3>
